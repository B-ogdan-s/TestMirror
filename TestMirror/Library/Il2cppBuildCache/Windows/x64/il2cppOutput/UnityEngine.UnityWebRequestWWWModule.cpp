...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR String_t* WWW_EscapeURL_m26FFA65AB485ABD0F58782DA88BFAF022704687B (String_t* ___s0, Encoding_tE901442411E2E70039D2A4AE77FB81C3D6064827 * ___e1, const RuntimeMethod* method);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR String_t* WWW_EscapeURL_m6BE746EF27C0DB6DED0EE26EC2BD1FD6B422A4AC (String_t* ___s0, const RuntimeMethod* method)
{
	String_t* V_0 = NULL;
	{
		String_t* L_0 = ___s0;
		...
		String_t* L_2;
		L_2 = WWW_EscapeURL_m26FFA65AB485ABD0F58782DA88BFAF022704687B(L_0, L_1, /*hidden argument*/NULL);
		V_0 = L_2;
		goto IL_000f;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR String_t* WWW_EscapeURL_m26FFA65AB485ABD0F58782DA88BFAF022704687B (String_t* ___s0, Encoding_tE901442411E2E70039D2A4AE77FB81C3D6064827 * ___e1, const RuntimeMethod* method)
{
	...
	{
		String_t* L_0 = ___s0;
		Encoding_tE901442411E2E70039D2A4AE77FB81C3D6064827 * L_1 = ___e1;
		String_t* L_2;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void WWW__ctor_mFB9E9E1DE62E5826F643B25B3AB6BE33B681B0F4 (WWW_tCC46D6E5A368D4A83A3D6FAFF00B19700C5373E2 * __this, String_t* ___url0, ByteU5BU5D_tDBBEB0E8362242FA7223000D978B0DD19D4B0726* ___postData1, const RuntimeMethod* method)
{
	...
	UploadHandler_t5F80A2A6874D4D330751BE3524009C21C9B74BDA * V_0 = NULL;
	{
		...
		NullCheck(L_2);
		UnityWebRequest_set_chunkedTransfer_mA743E172FDB5D5892DD6D3AA6836B66CD6233B5B(L_2, (bool)0, /*hidden argument*/NULL);
		ByteU5BU5D_tDBBEB0E8362242FA7223000D978B0DD19D4B0726* L_3 = ___postData1;
		...
		V_0 = L_4;
		UploadHandler_t5F80A2A6874D4D330751BE3524009C21C9B74BDA * L_5 = V_0;
		NullCheck(L_5);
		UploadHandler_set_contentType_mAECD24AB554541300BD126E01C65329F0A29A328(L_5, _stringLiteral14B6DF3349D302FD20ED0B3BD448C2045066E9BE, /*hidden argument*/NULL);
		UnityWebRequest_tB75B39F6951CA0DBA2D5BEDF85FDCAAC6026A37E * L_6 = __this->get__uwr_0();
		UploadHandler_t5F80A2A6874D4D330751BE3524009C21C9B74BDA * L_7 = V_0;
		NullCheck(L_6);
		UnityWebRequest_set_uploadHandler_m8D5DF24FBE7F8F0DCF27E11CE3C6CF4363DF23BA(L_6, L_7, /*hidden argument*/NULL);
